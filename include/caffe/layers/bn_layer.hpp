...
protected: 
  ...
  void Forward_cpu_fc(const vector<Blob<Dtype>*>& bottom, 
    const vector<Blob<Dtype>*>& top); 
  void Forward_cpu_conv(const vector<Blob<Dtype>*>& bottom, 
    const vector<Blob<Dtype>*>& top); 
  void Backward_cpu_fc(const vector<Blob<Dtype>*>& top, 
    const vector<bool>& propagate_down, const vector<Blob<Dtype>*>& bottom); 
  void Backward_cpu_conv(const vector<Blob<Dtype>*>& top, 
    const vector<bool>& propagate_down, const vector<Blob<Dtype>*>& bottom); 
